...
<https://classroom.github.com/a/hRBGoUN_>
...
2. The homework is meant to be a group assignment. The team size is limited to three members. The first member of the group can open the assignment and create the team. The rest of the members can select that team when joining.
After accepting the assignment, you will see a page with a link to your homework repository.

![Create a team](figures/hw/02-Create-Team.png)
![Join an existing team](figures/hw/02a-Join-Team.png)
...
5. This is it, you repository is now configured and you will receive 
a notification when your assignment is available. If you have any questions, please email me at [amarov\@feb.uni-sofia.bg](mailto:amarov\@feb.uni-sofia.bg).
