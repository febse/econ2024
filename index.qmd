...
All classes will be held in room 308 of the Faculty of Economics and Business.

1. Tu 10:15-11:45 in room 308 (will move to room 303 after 27.02.2024)
2. Tu 12:15-13:45 in room 308
...
[https://github.com/febse/econ2024](https://github.com/febse/econ2024)
...
2. Open a GitHub account at [https://github.com/signup](https://github.com/signup).
While you don't need an account to download the course materials, you will need
one to receive and  submit your assignments (this will be explained in details during
the exercise classes). You can apply for the GitHub student benefits at [https://education.github.com/pack](https://education.github.com/pack). If approved
you can receive free access to the GitHub Pro plan and to GitHub Copilot, an AI tool
...
5. Should you encounter difficulties installing R and R Studio, you can watch
these video guides:
