...
## OLS using the `lm` function in ```{html}
...
First, let us think about the data in terms of vectors.
...
where $||x||$ and $||y||$ are the lengths of the vectors and $\theta$ is the angle between the two vectors.
