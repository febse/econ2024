...
crime <- read_tsv("https://raw.githubusercontent.com/febse/data/main/econ/crime.csv") %>%
  select(-I)
```
...
Predict the crime rate in 3 hypothetical counties using the centered
predictor model.
...
## Third model: crime, education, and urbanization
